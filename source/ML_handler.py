...
from data_handler import normalize, denormalize
...
def train_solver_autoencoder_epoch(model, device, train_loader, optimizer, criterion,  vel_space_max, vel_space_min, weights=[1,1]):
...
def run_training_solver_autoencoder(model_solver_autoencoder,num_epochs, lr, batch_size, train_params, train_vel, test_params, test_vel, device,  vel_space_max, vel_space_min, weights = [1,1]):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        train_loss, train_loss_enc_dec, train_loss_solver_enc = train_solver_autoencoder_epoch(
           model_solver_autoencoder, device, train_loader, optimizer, criterion,vel_space_max, vel_space_min, weights, 
        )
